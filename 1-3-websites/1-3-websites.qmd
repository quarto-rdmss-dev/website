...
::: notes
Instructor: keep this tight to ~12 min. Show _quarto.yml + index.qmd + one nav entry. Skip the about-page deep dive (covered in pre-course work and the 2-1-about-page reference page).
:::
...
Anything from Websites you'd like clarified before we publish?
:::
