...
::: {.callout-note}
The screenshots below are taken from a different course. The steps are exactly the same, but where the screenshots show another workspace or project name, use `{{< var course.code >}}` instead.
:::

1. Open the "Content" page of the Posit Cloud workspace for the course: <{{< var resources.posit-space-content >}}>
