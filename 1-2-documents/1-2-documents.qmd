...
::: task
-   Open `citations.qmd` in RStudio.
-   Follow the two short tasks: add one in-text citation, add one parenthetical citation.
-   Render and observe the auto-generated reference list at the bottom of the document.
:::
