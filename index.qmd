...
Thank you for your interest in this course. Your course instructor [{{< var author >}}]({{< var author-url >}}) is looking forward to meet you.

We will meet on {{< var session.day-label >}} of the {{< var session.event-name >}} in room {{< var session.room >}} at the following time:
...
-   [Step 4](0-2-pre-work/04-survey.html): Fill out the pre-course survey by [**{{< var session.survey-deadline >}}**]{.highlight-yellow}.
...
## {{< fa calendar-days >}} Course schedule

```{r}
#| tbl-colwidths: [25,75]
read_csv(here::here("data/course-schedule.csv")) |>
  filter(day == 1) |> 
